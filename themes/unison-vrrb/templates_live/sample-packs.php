...
<main class="flex-grow-1 p-0">
    <section class="p-0 front-cards-section">
        <div class="container">
            <div class="row">
                <div class="col-xxxl-9 col-xxl-9 col-xl-11 col-lg-11 col-md-11 col-xs-12 mx-auto p-0">
                    ...
                    <div class="row m-0 products-row">
                        ...
                        <div class="col-xxxl-4 col-lg-4 col-sm-6 col-xs-6 p-0 samplepack-item">
                                ...
                                <a href="<?php echo get_the_permalink($featured_product->ID); ?>">
                                    <div class="card-image">
                                        <img class="card-img img-fluid thumb"
                                            src="<?php echo get_the_post_thumbnail_url($featured_product->ID); ?>"
                                            alt="Image caption">
                                ...
                                <div class="text-white front-card d-flex pb-3">
                                    <div class="single_product_play">
                                        <div class="play_single_audio">
                                            <a href="<?php echo get_the_permalink($featured_product->ID); ?>"
                                                class="btn-play js-sound" data-file="<?php echo $music; ?>"
                                    ...
                                    <div class="col-10 p-0 align-self-center">
                                        <a href="<?php echo get_the_permalink($featured_product->ID); ?>" class="product-text">
                                            ...
                                            <p
                                                ...
                                                <?php echo get_the_title($featured_product->ID); ?></p>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row m-0 products-row pb-5 d-none" id="sample-packs-products">
                        ...
                        <div
                            class="col-xl-3 col-lg-3 col-sm-6 col-xs-6 p-0 filter samplepack-item <?php echo $current_cat; ?>">
                            <div class="card bg-transparent">
                                ...
                                <a href="<?php
                                    ...
                                    <div class="card-image">
                                        <img class="card-img img-fluid"
                                            src="<?php bloginfo('template_url')?>/assets/images/Rectangle%2025-1.jpg"
                                            alt="Image caption">
                                        <div class="image-overlay d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="single_product_play">
                                        <div class="play_single_audio">
                                            <a href="<?php the_permalink(); ?>" class="btn-play js-sound"
                                                data-file="<?php echo $music ?>" data-id="<?php echo $post->ID; ?>">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-10 p-0 align-self-center">
