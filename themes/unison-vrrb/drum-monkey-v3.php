    ...
    <div class="container">
        <div class="time-essence-inner">
            <div class="section-heading text-center">
                ...
                <figure class="mt-4">
                    <img src="<?php echo get_bloginfo('template_url'); ?>/images/bonus-img/time-essence.png" class="mw-100" alt="" width="250" tabindex="0">
                </figure>
                <h3 class="sub-heading mt-2">The <span class="yellow-text">Huge $150 Discount & 5 Exclusive Bonuses</span> <br>Are Only Available For A Very Limited Time.</h3>
            </div>
            <div class="content-wrap width-sm-100">
				...
				<p class="mb-0">Instead, choose your preferred payment option below and <b>secure your very own license now.</b></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-md-6">
                    <div class="column-inner h-100">
                        ...
                        <div class="payment-price text-center">
                            ...
                            <h3><span style="font-size:22px;"><del>$14.99 </del></span>  $7.49 <span class="h3 small"> then $14.99 x 21 months</span></h3>
                        </div>
                        <div class="actions-btn btn-design text-center p-0 my-3">
                            <a href="https://app.unison.audio/cart/add/0-11-75-79?promo=s7r8c2r5t0" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">GET DRUM MONKEY NOW</span><span class="elButtonSub">Rent-To-Own | Pause Or Cancel Anytime</span></a>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="column-inner bg-yellow h-100">
                        <div class="title-box text-center">
                            ...
                            <h3>1 Single Payment <span class="red-text respnosive-block">(Save $75)</span></h3>
                            <h4>Here's <span class="red-text">What You'll Get:</span></h4>
                        </div>
                        ...
                        <div class="payment-price text-center">
                            ...
                            <h3>$1,062</h3>
                            <h4 class="red-text mt-3 mb-1">Today Only:</h4>
                            <h3>1 Single Payment Of <span><del>$397</del></span> $247</h3>
                        </div>
                        <div class="actions-btn btn-design text-center p-0 my-3">
                            <a href="https://unison.audio/dm-special-777-order-secure" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">GET DRUM MONKEY NOW</span><span class="elButtonSub">For $150 Off + 5 Free Bonuses</span></a>
                        </div>
                        <p class="money-back">Try It Risk-Free | 60-Day 100% Money-Back Guarantee</p>
                        <div class="payment-methd text-center mt-2">
                            <img src="<?php echo get_bloginfo('template_url'); ?>/images/drum-monkey/credit-paypal.png" class="mw-100" alt="" width="250" tabindex="0">
            ...
            <div class="accordion custom-accordion width-sm-100" id="accordionExample">
                ...
                <div class="card">
                    ...
                    <div id="collapse-3" class="collapse" aria-labelledby="heading-3">
                        <div class="card-body">
                        <p>Drum Monkey is compatible Ableton Live, FL Studio, Logic Pro, Pro Tools, Studio One, Cubase, Reason, Reaper, Cakewalk, Mixcraft & Bitwig Studio on both Mac & PC. Please do not purchase Drum Monkey unless you use one of the DAW's listed.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapse-4" class="collapse" aria-labelledby="heading-4">
                        ...
                        <p>Plus, Drum Monkey is <b>protected by PACE Fusion Technology</b> which is the most secure license management method available. That means the plugin code is protected at the highest level and all producers who purchase can have peace of mind that their investment is protected and rock-solid.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div id="collapse-11" class="collapse" aria-labelledby="heading-11">
                        <div class="card-body">
                            ...
                            <p>Although you <b>save an additional $75 with the single-pay option,</b> if you choose rent-to-own, you pay only $7.50 today, followed by 21 monthly payments of $14.99, totalling $322.29. If at any point a payment fails, your license will be paused and Drum monkey will stop functioning until the payment goes through. You can also <b>pause, cancel or pay off your rent-to-own plan yourself with 1 click</b> from your account.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
