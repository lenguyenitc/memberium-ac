        ...
        <div class="introducing-drum-monkey-inner text-center">
            ...
            <div class="video-wrapper">
                <div class="introducing-video-sec">
                    <video width="100%" autoplay="" loop="" muted="" playsinline="" src="https://dnnp2imjk0usi.cloudfront.net/Landing+Page+ScreenCaps/Top+Section.mp4"></video>
                </div>
            </div>
        ...
        <div class="with-drum-monkey-inner">
            ...
            <div class="drum-categories-sec mw-100">
                <div class="row">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/MIDI-Wiz_Hit_1_1X1_alpha-no-shadow.gif" class="mw-100" width="475" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-reverse">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/MIDI-Wiz_Hit_2_1X1_alpha-no-shadow.gif" class="mw-100" width="475" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/8.-Inspired---Idea-Right.png" class="mw-100" width="300" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/8.-Inspired---Idea-Right.png" class="mw-100" alt="" width="425" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/10.-Running-Fast-Right.png" class="mw-100" width="300" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/10.-Running-Fast-Right.png" class="mw-100" alt="" width="425" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/9.-Sneaky-Right.png" class="mw-100" width="300" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/9.-Sneaky-Right.png" class="mw-100" alt="" width="425" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/11.-Strong-Proud-Right.png" class="mw-100" width="300" alt="" width="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/11.-Strong-Proud-Right.png" class="mw-100" alt="" width="425" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 left">
                    <div class="column-inner h-100">
                        ...
                        <div class="payment-price text-center">
                            ...
                            <h3>$19.99 <span class="h3 small">x 22 months</span></h3>
                        </div>
                        <div class="actions-btn btn-design text-center p-0 my-3">
                            <a href="https://app.unison.audio/cart/add/G-73-51-81" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">GET MIDI WIZARD NOW</span><span class="elButtonSub">Rent-To-Own | Pause Or Cancel Anytime</span></a>
                        </div>
                ...
                <div class="col-md-6 right">
                    <div class="column-inner bg-white h-100">
                        <div class="title-box text-center">
                            ...
                            <h3><span class="yellow-text">1 Single Payment (Save $40)</span></h3>
                        ...
                        <div class="payment-price text-center">
                            ...
                            <h4 class="yellow-text mt-3 mb-1">Today Only:</h4>
                            <h3 class="black-text">1 Single Payment Of <span><del>$497</del></span> $397</h3>
                        </div>
                        <div class="actions-btn btn-design text-center p-0 my-3">
                            <a href="https://unison.audio/midi-wizard-order-secure/" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">GET MIDI WIZARD NOW</span><span class="elButtonSub">For $100 Off + 4 Free Bonuses</span></a>
                        </div>
                        <p class="money-back">Try It Risk-Free | 60-Day 100% Money-Back Guarantee</p>
                        <div class="payment-methd text-center mt-2">
                            <img src="<?php echo get_bloginfo('template_url'); ?>/images/midi-wizard/credit-paypal.png" class="mw-100" alt="" width="250" tabindex="0">
                ...
                <div class="card">
                    ...
                    <div id="collapse-9" class="collapse" aria-labelledby="heading-9">
                        <div class="card-body">
                            ...
                            <p>Although you <b>save an additional $40 with the full-pay option, </b>if you choose rent-to-own, you pay only $19.99 today, followed by 22 more monthly payments of $19.99, totalling $439.78. If at any point a payment fails, your license will be paused and MIDI Wizard will stop functioning until the payment goes through. You can also <b>pause or cancel your rent-to-own plan yourself with 1 click </b>from your account.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
