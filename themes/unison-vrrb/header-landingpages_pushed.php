            ...
            <div class="col-12 p-0">
                <div class="d-flex justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <?php if(!is_page_template('drum-monkey-v2.php') && !is_page_template('drum-monkey-v3.php') && !is_page_template('drum-monkey-v4.php') && !is_page_template('midi-wizard-v2.php') && !is_page_template('midi-wizard-v3.php') && !is_page_template('midi-wizard-v4.php') && !is_page_template('midi-chord-pack-special-v2.php') ){ ?>
