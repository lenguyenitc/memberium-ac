<?php
/*
 * Template Name: Midi chord pack special v2
 *
 * */
        ...
        <div class="get-bonusNow_inner">
            ...
            <div class="content-box w-full-770">
                ...
                <div class="actions-btn btn-design text-center">
                    <a href="https://web.unison.audio/complete-order-18567936" class="elButton"><span class="elButtonMain">GET THE PACK</span><span class="elButtonSub">for 60% Off Now</span></a>
                </div>
    ...
    $(document).ready(function(){
        ...
        $('#elButtonMainPopUp').on('click', function(){
            ...
            $.post(ajaxurl, data, function(response){
                if(response == 'success'){
                    $('.midi-popup__loader').css('display','none');
                    window.location.href = "https://web.unison.audio/complete-order-18567936?email="+mmail;
                }
                else{
                    $('.midi-popup__loader').css('display','none');
                    jQuery('.notification-error').remove();
