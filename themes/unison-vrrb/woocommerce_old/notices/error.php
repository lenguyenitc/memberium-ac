...
<?php if(is_account_page()){ 
    ...
    ?>
       <ul class="woocommerce-error my-account-error" role="alert">
        <?php if (!empty($add_message)) { ?>
              <li>
                <?php echo __($add_message, 'woocommerce' ); ?>
              </li>
          <?php } ?>     
    <?php foreach ( $notices as $notice ) : ?>
        <?php if ( $notice['data']['id'] == 'account_first_name') { ?>
              <li<?php echo wc_get_notice_data_attr( $notice ); ?>>
                <?php echo __( 'Your first name required.', 'woocommerce' ); ?>
              </li>
         <?php } elseif ( $notice['data']['id'] == 'account_last_name') { ?>
              <li<?php echo wc_get_notice_data_attr( $notice ); ?>>
                <?php echo __( 'Your last name required.', 'woocommerce' ); ?>
              </li>
         <?php } elseif ( $notice['data']['id'] == 'account_email') { ?>
              <li<?php echo wc_get_notice_data_attr( $notice ); ?>>
                <?php echo __( 'Your email required.', 'woocommerce' ); ?>
              </li>
         <?php } else { ?>
        <li<?php echo wc_get_notice_data_attr( $notice ); ?>>
