...
?>
<?php if($current_slug == 'my-account' || $current_slug == 'mbr-portal-account-details'): ?>
<div class="jumbotron text-white  account-jumbotron-padding bg-light-blue-gradient">
    <div class="container">
        <div class="row col-xxxl-10 col-xxl-10 col-xl-11 col-lg-11 col-md-11 col-xs-11 col-sm-11 mx-auto  col-sm-12 align-items-center pl-0 pr-0 flex-xxxl-row flex-xxl-row flex-xl-row flex-lg-row  flex-md-column-reverse flex-sm-column-reverse flex-xs-column-reverse">
            ...
            <div class="col-xxxl-3 offset-xxxl-4 col-xxl-3 col-lg-2 offset-lg-5 offset-xxl-4 col-xl-2 offset-xl-5 col-sm-12  pr-0 col-xs-12 col-sm-12">
