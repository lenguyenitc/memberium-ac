...
if ( $available_gateways ) : ?>
    <h2 class="heading-add-payment-method"><?php esc_html_e('Add New Payment Method', 'woocommerce'); ?></h2>
    <form id="add_payment_method" method="post">
        <div id="payment" class="woocommerce-Payment">
            ...
            <div class="form-row">
                ...
                <button type="submit" class="woocommerce-Button woocommerce-Button--alt button alt" id="place_order add-payment-method-my-account" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></button>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(){
            //jQuery('#stripe-payment-data p').html('Save credit card');
        });
    </script>
<?php else : ?>
