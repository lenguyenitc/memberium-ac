...
<div class="copy" itemprop="description">
	...
	if ($facebook){
		echo '<a href="http://'.$facebook.'" target="_blank" class="soc-custom facebook"></a>';
	}
	if ($twitter){
		echo '<a href="http://'.$twitter.'" target="_blank" class="soc-custom twitter"></a>';
	}
	if ($soundcloud){
		echo '<a href="http://'.$soundcloud.'" target="_blank" class="soc-custom soundcloud"></a>';
	}
	if ($spotify){
