...
?>
<div class="pl-0 pr-0 col-xxxl-6 col-xxl-6 col-xl-6 col-lg-6  col-md-11 col-sm-11 col-xs-12">
    <h3><?php _e('Customer Details', 'woocommerce'); ?></h3>
    <div class="text-white  customer-details">
        <ul class="text-center pl-0 mb-0">
            <li class="text-left">
                <span class="table-grey mr-1 pl-0">Name:</span>
                <?php
            ...
            <li class="text-left">
                <span class="table-grey mr-1 pl-0">Email:</span>
