                                    ...
                                    <div class="col p-0 pt-3">
                                        ...
                                        <form name="checkout" method="post" class="checkout woocommerce-checkout"
                                            ...
                                            <div id="payment" class="woocommerce-checkout-payment">
                                                ...
                                                <!--                                                    <li-->
                                                <!--                                                        class="wc_payment_method payment_method_stripe position-relative">-->
                                                ...
                                                <!--                                                            <img src="./assets/images/cards-logo.png"-->
                                                <!--                                                                alt="Credit Cards">-->
                                                <!--                                                        </div>-->
                                                <!--                                                    </li>-->
                                                <!--                                                    <li-->
                                                <!--                                                        class="wc_payment_method payment_method_paypal position-relative">-->
                                                ...
                                                <!--                                                    </li>-->
                                                <!--                                                    <button type="submit"-->
                                                <!--                                                        class="badge badge-success complete-payment-button">-->
                                                <!--                                                        <p>complete order</p>-->
                                                ...
                                                <!--                                                        if you fail to do so. <br /><input type="submit"-->
...
<main class="flex-grow-1 midi-box-checkout pt-sm-5 pt-3 bg-dark">
    <section id="cart_woo" class="p-0">
        <div class="container">
            <div class="row">
                <div class="col-xxxl-9 col-xxl-9 col-xl-11 col-lg-11 col-md-11 col-sm-12 mx-auto">
                        ...
                        <div class="col-xxxl-7 col-lg-6 col-sm-12 bg-transparent text-center">
                            ...
                            <form class="frmCart coupon_form" action="<?php echo esc_url(wc_get_cart_url()); ?>"
                                ...
                                <label for="coupon_code"
                                    class="p2 my-4 text-light coupan-form-togg"><?php esc_html_e('Promo Code?', 'woocommerce'); ?></label>
                                    <div class='coupan-form-togg-act' style='display:none;'>
                                    ...
                                    <ul class="nav steps-tabs">
                                        ...
                                        <li class="nav-item step step-2 <?php echo (is_user_logged_in()) ? 'active' : '' ?>"
                                            ...
                                            <div class="step-text">
                                                <?php
                                                if(WC()->cart->total>0){
                                                    $payment_type_text = 'payment';
                                                }else{
                                                    $payment_type_text = 'Download';
                                                }
                                                ?>
                                                <p class="step-title text-uppercase"><?php echo $payment_type_text; ?></p>
                                                <p class="step-subtitle text-capitalize">get access now</p>
                                            </div>
                                        </li>
                                    </ul>
                                        ...
                                        <ul class="w-100 d-inline-flex text-white p1 flex-column mt-3">
                                            ...
                                            <li>
                                                <div class="d-flex col justify-content-between p-0 pt-2"
                                                    ...
                                                    <span class="sezzle_price price text-tabs">
                                                        <?php wc_cart_totals_order_total_html(); ?>
                                                    </span>
                                                </div>
                                            </li>
