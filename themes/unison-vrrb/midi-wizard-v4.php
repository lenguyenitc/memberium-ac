            ...
            <div class="row">
                <div class="col-md-12">                    
                    <div class="actions-btn btn-design text-center">
                        <a href="https://app.unison.audio/cart/add/6-88-55-50" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">START FREE TRIAL NOW</span><span class="elButtonSub">Try MIDI Wizard Free For 7 Days</span></a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="category-content">
                                <p>Although most of the chord progressions & melodies you generate will <b>sound amazing </b>off the bat...</p>
                    ...
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="category-content">
                                ...
                                <p>Whether you're getting a song started, finished or stocking up on inspiration, <b>MIDI Wizard's</b> got you covered.</p>
                                <div class="actions-btn btn-design text-center p-0 mt-4">
                                    <a href="https://app.unison.audio/cart/add/6-88-55-50" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">START FREE TRIAL NOW</span><span class="elButtonSub">Try MIDI Wizard Free For 7 Days</span></a>
                                </div>
                            </div>
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="category-content">
                                <p>No cheap stock sounds here — <b>MIDI Wizard</b> hooks up to <b>all your favorite</b> synth & instrument VSTs.</p>
    ...
    <div class="container">
        <div class="time-essence-inner">
            <div class="section-heading text-center">
                ...
                <h3 class="sub-heading mt-2">The 7-Day Free Trial Is Only Available<br>For A Very Limited Time</h3>
            </div>
            <div class="content-wrap width-sm-100">
                <p>To be fair to the <b>thousands of producers who paid full price...</b></p>
                <p>We're <b>ending this special free-trial offer very soon.</b></p>
                ...
                <p>Instead, start your free trial below and <b>secure your very own license now.</b></p>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-md-6 right">
                    <div class="column-inner bg-white h-100">
                        <div class="title-box text-center">
                            ...
                            <h3><span class="yellow-text">MIDI Wizard 7-Day Free Trial</span></h3>
                        ...
                        <div class="payment-price text-center">
                            ...
                            <h3 class="black-text">7-Day Free Trial <span style="font-size: 16px; color:#242424;">| Then $19.99 x 22 months</span></h3>
                        </div>
                    ...
                    <div class="col-md-7">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="category-content">
                                ...
                                <p>3. <span class="yellow-text">Get instant access</span> to your MIDI Wizard license.</p>
                    ...
                    <div class="card-header" id="heading-3">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
                                <span class="white-text">2.</span> What DAWs is MIDI Wizard compatible with?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-4">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
                                <span class="white-text">3.</span> How does authorization work for MIDI Wizard?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-5">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
                                <span class="white-text">4.</span> Are the chord progressions & melodies I generate royalty free?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-6">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">
                                <span class="white-text">5.</span> Will MIDI Wizard be difficult to use?
                            </button>
                        </h2>
                    </div>
                    <div id="collapse-6" class="collapse" aria-labelledby="heading-6">
                        <div class="card-body">
                            <p>MIDI Wizard is <b>super simple and easy to use. </b>Whether you're a <b>beginner, intermediate or advancedb </b>we've taken the hard work out of it for you and set you up for <b>instant results.</b> Just install the plugin, choose your key/genre/length and<b> click the generate button. </b>From there you can customize everything if you'd like, <b>drag & drop into your project</b> and <b>have fun finishing & releasing hit songs.</b></p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header" id="heading-7">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-7" aria-expanded="false" aria-controls="collapse-7">
                                <span class="white-text">6.</span> Does it matter what genre I produce?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-8">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-8" aria-expanded="false" aria-controls="collapse-8">
                                <span class="white-text">7.</span> Is using the MIDI Wizard cheating?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-10">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-10" aria-expanded="false" aria-controls="collapse-10">
                                <span class="white-text">8.</span> What if I'm unsatisfied with MIDI Wizard?
                            </button>
                        </h2>
                    </div>
                    <div id="collapse-10" class="collapse" aria-labelledby="heading-10">
                        <div class="card-body">
                            <p>During your <b>7-day free trial, you can cancel it yourself with 1 click</b> from your account dashboard. No questions asked. No weirdness. No hard feelings. <b>You have nothing to lose and everything to gain.</b></p>
                        </div>
                    </div>
                </div>
