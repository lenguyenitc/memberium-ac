            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- <div class="actions-btn">
                        <a href="https://unison.audio/drum-monkey-order-secure" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" style="color: rgb(255, 255, 255); font-weight: 600; background-color: rgb(249, 48, 3); font-size: 27px;" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">START FREE TRIAL NOW</span><span class="elButtonSub">Try Drum Monkey Free For 7 Days</span></a>
                    </div> -->
                    <div class="actions-btn btn-design text-center">
                        <a href="https://app.unison.audio/cart/add/T-05-92-20" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">START FREE TRIAL NOW</span><span class="elButtonSub">Try Drum Monkey Free For 7 Days</span></a>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="time-essence-inner">
            <div class="section-heading text-center">
                ...
                <figure style="margin-top:20px;">
                    <img src="<?php echo get_bloginfo('template_url'); ?>/images/bonus-img/time-essence.png" class="elIMG ximg" alt="" width="350" tabindex="0">
                </figure>
                <h3 class="sub-heading" style="margin-top:35px !important;">The <span class="yellow-text">7-Day Free Trial</span> Is Only Available<br>For A Very Limited Time</h3>
            </div>
            <div class="content-wrap width-sm-100">
                <p>To be fair to the <b>thousands of producers who paid full price...</b></p>
				<p>We're <b>ending this special free-trial offer</b> very soon.</p>
                ...
                <p>This special 7-day free trial offer could <b>already be over.</b></p>
				...
				<p class="mb-0">Instead, start your free trial below and <b>secure your very own license now.</b></p>
            </div>
        </div>
    </div>
</section>
...
<section class="payment-options page-sec" id="scroll-Yes">
    <div class="container">
        <div class="payment-options-inner">
            <div class="section-heading text-center">
                <h2 class="heading mb-5">Click The Button Below To Start Your Free Trial Now:</h2>
            </div>
                ...
                <div class="col-md-6">
                    <div class="column-inner bg-yellow h-100">
                        <div class="title-box text-center">
                            ...
                            <h3>Drum Monkey 7-Day Free Trial</h3>
                        ...
                        <div class="payment-wrap right">
                            <div class="category-content">
                                <ul class="list-point">
                                    ...
                                    <li><i contenteditable="false" class="fa fa-fw fa-check"></i> Full Access To All Features
                                    </li>
                        ...
                        <div class="payment-price text-center">
                            ...
                            <h3>7-Day Free Trial <span style="font-size: 16px; color:#242424;">| Then $14.99 x 22 months</span></h3>
                        </div>
                        ...
                        <p class="money-back">No Commitments | Cancel Anytime With 1 Click</p>
                ...
                <div class="row row-reverse">
                    <div class="col-md-7">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="category-content">
                                <p>1. <span class="yellow-text">Click</span> the "Start Free Trial Now" button below.</p>
                                <p>2. <span class="yellow-text">Complete your order</span> on the next page.</p>
                                <p>3. <span class="yellow-text">Get instant access</span> to your Drum Monkey license.</p>                                
                                <p>4. <span class="yellow-text">Download</span> the installer and activate your copy.</p>
        ...
        <div class="faq-sec-inner">
            ...
            <div class="accordion custom-accordion width-sm-100" id="accordionExample">
                <div class="card">
                    ...
                    <div id="collapse-1" class="collapse" aria-labelledby="heading-1">
                        <div class="card-body">
                            <p>Your installer download link and Activation Code will be <b>sent to your email address and enabled in your Unison account immediately after your purchase.</b> The private Facebook group link and details will also be sent to your email and mentioned in your account.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header" id="heading-2">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
                                <span class="yellow-text">2.</span> What DAWs is Drum Monkey compatible with?
                            </button>
                        </h2>
                    </div>
                    <div id="collapse-2" class="collapse" aria-labelledby="heading-2">
                        <div class="card-body">
                            <p>Drum Monkey is compatible <b>Ableton Live, FL Studio, Logic Pro, Pro Tools, Studio One, Cubase, Reason, Reaper, Cakewalk, Mixcraft &amp; Bitwig Studio on both Mac &amp; PC.</b> Please do not get Drum Monkey unless you use one of the DAW's listed.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="card-header" id="heading-3">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
                                <span class="yellow-text">3.</span> How does authorization work for Drum Monkey?
                            </button>
                        </h2>
                    </div>
                    <div id="collapse-3" class="collapse" aria-labelledby="heading-3">
                        <div class="card-body">
                            <p>After completing your order, you'll get installer downloads for both Mac &amp; PC, as well as an Activation Code. <b>All you need to do is run the installer, open up your DAW, load up Drum Monkey, click "Activate", enter in your Activation Code and you're good to go. The whole process takes less than 60 seconds.</b> You can authorize Drum Monkey with your single Activation Code on <b>up to 2 machines you own simultaneously.</b></p><br/>
                    ...
                    <div class="card-header" id="heading-5">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
                                <span class="yellow-text">4.</span> Are the drum loops I generate royalty free?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-6">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">
                                <span class="yellow-text">5.</span> How big is the included factory sample library?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-7">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-7" aria-expanded="false" aria-controls="collapse-7">
                                <span class="yellow-text">6.</span> Can I use Drum Monkey with my own samples?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-8">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-8" aria-expanded="false" aria-controls="collapse-8">
                                <span class="yellow-text">7.</span> Will Drum Monkey be difficult to use?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-9">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-9" aria-expanded="false" aria-controls="collapse-9">
                                <span class="yellow-text">8.</span> Does it matter what genre I produce?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-10">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-10" aria-expanded="false" aria-controls="collapse-10">
                                <span class="yellow-text">9.</span> Is using Drum Monkey cheating?
                            </button>
                        </h2>
                    </div>
                    ...
                    <div class="card-header" id="heading-12">
                        <h2 class="mb-0">
                            <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapse-12" aria-expanded="false" aria-controls="collapse-12">
                                <span class="yellow-text">10.</span> What if I'm unsatisfied with Drum Monkey?
                            </button>
                        </h2>
                    </div>
                    <div id="collapse-12" class="collapse" aria-labelledby="heading-12">
                        <div class="card-body">
                            <p>During your 7-day free trial, you can cancel it yourself with 1 click from your account dashboard. No questions asked. No weirdness. No hard feelings. <b>You have nothing to lose and everything to gain.</b></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <span class="d-block text-center" style="font-size:12px;font-weight:500;">No Commitments | Cancel Anytime With 1 Click</span>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
