            ...
            <div>
                <div class="col-12">
                    <div class="row d-flex ">
                        ...
                        <?php if(!is_page_template('drum-monkey-v2.php') && !is_page_template('drum-monkey-v3.php') && !is_page_template('drum-monkey-v4.php') && !is_page_template('midi-wizard-v2.php') && !is_page_template('midi-wizard-v3.php') && !is_page_template('midi-wizard-v4.php') && !is_page_template('midi-chord-pack-special-v2.php') && !is_page_template('midi-chord-pack-special-v3.php') ){ ?>
                            <span class="bf-logo-wrap">
                                <img class="black_friday" src="<?php bloginfo('template_url') ?>/assets/images/bf-unison.png">
                            </span>
                        <?php } ?>
                    </div>
                </div>
