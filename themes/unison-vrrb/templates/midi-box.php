...
<main class="flex-grow-1 midi-box-page custom1">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-xl-6 col-xxl-6 text-center mx-auto p-0">
                        ...
                        <a href="#midi-box-pricing" rel="noopener noreferrer">
                            <div class="text-center mx-auto bg-success button-green-glow">
                                    <span class="font-weight-bold text-white">GET MIDI BOX
                                    NOW</span><br />
                                <span class="font-weight-bold" style="font-size: 12px;color:#8de6da; line-height: 12px">Limited-Time
                                    Special Launch Offer</span>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="row mx-auto">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-xxxl-12 mx-auto p-0">
                        <div class="d-flex flex-column-reverse flex-lg-row row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6 col-xxxl-6 mx-auto mt-3 mb-4 d-flex flex-column pr-lg-0">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-10 col-xxl-10 col-xxxl-9 mx-auto">
                    ...
                    <div class="midi-box-section-top d-flex flex-column-reverse flex-lg-row row text-white second-section-sky">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 mx-auto">
                    <a href="#midi-box-pricing" rel="noopener noreferrer">
                        <div class="mx-auto text-center button-green-glow">
                                <span class="font-weight-bold">GET MIDI
                                        BOX NOW</span><br />
                            <span class="font-weight-bold" style="font-size:12px;line-height:12px;color: #8de6da;">Limited-Time
                                        Special Launch Offer</span>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="d-flex flex-column-reverse flex-lg-row text-center align-items-center">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 text-center mx-auto text-xxl-right ml-5 video p-0">
                                ...
                                <video width="100%" height="100%" autoplay="" loop="" muted="" playsinline="">
                                    ...
                                    <source type="video/mp4" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+1+Video.mp4" />
                                    <!-- WebM/VP8 for Firefox4, Opera, and Chrome -->
                                    <source type="video/webm" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+1+Video.mp4" />
                                    <!-- M4V for Apple -->
                                    <source type="video/mp4" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+1+Video.mp4" />
                                    <!-- Ogg/Vorbis for older Firefox and Opera versions -->
                                    <source type="video/ogg" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+1+Video.mp4" />
                                </video>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="newCard-box bg-opacity mt-4">
                        <div class="d-flex flex-column-reverse flex-lg-row text-center align-items-center">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 text-center mx-auto text-xxl-right ml-5 video p-0">
                                ...
                                <video width="100%" height="100%" autoplay="" loop="" muted="" playsinline="">
                                    <!-- MP4 for Safari, IE9, iPhone, iPad, Android, and Windows Phone 7 -->
                                    <source type="video/mp4" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+2+Video.mp4" />
                                    <!-- WebM/VP8 for Firefox4, Opera, and Chrome -->
                                    <source type="video/webm" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+2+Video.mp4" />
                                    <!-- M4V for Apple -->
                                    <source type="video/mp4" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+2+Video.mp4" />
                                    <!-- Ogg/Vorbis for older Firefox and Opera versions -->
                                    <source type="video/ogg" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+2+Video.mp4" />
                                </video>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="newCard-box bg-opacity mt-4">
                        <div class="d-flex flex-column-reverse flex-lg-row text-center align-items-center">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 text-center mx-auto text-xxl-right video  ml-5 p-0">
                                ...
                                <video width="100%" height="100%" autoplay="" loop="" muted="" playsinline="">
                                    <!-- MP4 for Safari, IE9, iPhone, iPad, Android, and Windows Phone 7 -->
                                    <source type="video/mp4" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+3+Video.mp4" />
                                    <!-- WebM/VP8 for Firefox4, Opera, and Chrome -->
                                    <source type="video/webm" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+3+Video.mp4" />
                                    <!-- M4V for Apple -->
                                    <source type="video/mp4" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+3+Video.mp4" />
                                    <!-- Ogg/Vorbis for older Firefox and Opera versions -->
                                    <source type="video/ogg" src="<?php bloginfo('template_url') ?>/assets/videos/midi-box/MIDI+Box+Step+3+Video.mp4" />
                                </video>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-11 col-xl-11 col-xxl-11 col-xxxl-8 mx-auto text-center p-0">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-10 col-xl-9 mx-auto">
                        <h4 class="text-white title">Plus, Get <span class="color-teal"><u>5 Special Exclusive Launch
                            Bonuses</u></span> When You Order Now</h4>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="newCard-box bg-opacity font-weight-bold mb-1 mt-4 position-relative">
                    <div class="d-flex flex-column-reverse flex-lg-row">
                        <div class="col-md-12 col-lg-7 text-left p-0 pl-lg-3 pr-lg-5">
                            ...
                            <p>Beyond what you <b>already know about MIDI Box...</b></p> 
                            <p>There's some <b>secret uses that</b> would simply be <b>too powerful to reveal to everyone.</b></p> 
                            <p>In the <b>MIDI Box Advanced Implementation Training</b>, Unison co-founder and <b>producer with 30+ million plays Sep...</b></p> 
                            <p>Will be <b>demonstrating in real time</b> how to <b>use MIDI Box to easily make hit songs</b> in several genres.</p>
                            <p> Also, he'll show you <b>3 special ways you can use MIDI Box</b> to skyrocket your music production results.</p>
                        </div>
                        <div class="col-md-12 col-lg-5 pl-lg-5">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 mx-auto">
                        <a href="#midi-box-pricing" rel="noopener noreferrer">
                            <div class="text-center mx-auto bg-success p-3 button-green-glow mt-5">
                                    <span class="font-weight-bold text-white">GET MIDI BOX
                                    NOW</span><br />
                                <span class="font-weight-bold" style="font-size: 12px;color:#8de6da;">Limited-Time
                                    Special Launch Offer</span>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 col-xxl-11 col-xxxl-9 mx-auto text-cente p-0">
                ...
                <div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-xl-10 col-xxl-10 col-xxxl-8 mx-auto p-0">
                        <h4 class="text-white subtitle text-center text-lg-center">The 5 Free Exclusive Bonuses Are Only Available For A Limited Time</h4>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-11 col-xl-10 col-xxl-10 col-xxxl-8 mx-auto p-0">
                    <div class="newCard-box p-0 text-white text-left text-content w-100">
                        ...
                        <p class="card-text">It means you can secure the MIDI Box Pro tier with all 5 bonuses...</p>
    ...
    <section class="midi-box-pricing midi-box-section" id="midi-box-pricing">
       ...
       <?php }else{ ?>
        ...
        <div class="d-flex flex-column-reverse flex-lg-row row col-xxxl-10 col-lg-12 col-md-10 col-sm-12 mx-auto p-0 align-items-top">
            <div class="col-lg-4 col-xs-12 mx-auto px-xl-3 px-lg-2 p-0">
                <div class="m-0 card-green card-main">
                    <div class="card-main--inner text-center mt-0 pt-0">
                        ...
                        <?php
                        $type_of_bonus_lite = get_field('bonus_variation_products_light','486634');
                        $bonus_lite_total = get_field('bonus_value_lite','486634');
                        ...
                        <div class="bottom__content">
                            ...
                            <a href="/midi-box-lite-order-secure/?add-to-cart=486636" rel="noopener noreferrer">
                                <div class="text-center mx-auto button-green-offshadow btn-get btn-get-dark">
                                        <span class="text-white font-weight-bold">GET MIDI
                                                BOX
                                                LITE NOW</span><br />
                                    <span class="small-text">30-Day
                                                Money-Back Guaruntee</span>
                                </div>
                            </a>
                            <p class="text-center take-risk">Try It Risk Free, No Commitments,<br> Cancel Anytime With 1 Click</p>
                            <img src="<?php bloginfo('template_url') ?>/assets/images/Group 9414.png" style="width: 60%">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-xs-12 mx-auto px-xl-3 px-lg-2 p-0">
                <div class="card-main card-blue">
                    <div class="card-main--inner text-center mt-0 pt-0">
                        ...
                        $type_of_bonus_plus = get_field('bonus_variation_products_plus','486634');
                        $bonus_plus_total = get_field('bonus_value_plus','486634');
                        ...
                        <div class="bottom__content">
                            ...
                            <a href="/midi-box-plus-order-secure/?add-to-cart=486637" rel="noopener noreferrer">
                                <div class="text-center mx-auto  button-green-offshadow btn-get btn-get-dark">
                                        <span class="text-white font-weight-bold">GET MIDI
                                                        BOX
                                                        PLUS NOW</span><br />
            ...
            <div class="col-lg-4 col-xs-12 mx-auto px-xl-3 px-lg-2 p-0">
                <div class="mb-0 m-0 m-0 p-0 bg-white card-white" style="border-radius: 10px">
                    <div class="card-main--inner text-center mt-0 card-main">
                        ...
                        <?php
                        $type_of_bonus_pro = get_field('bonus_variation_products_pro','486634');
                        $bonus_pro_total = get_field('bonus_value_pro','486634');
                        ...
                        <div class="bottom__content">
                            ...
                            <a href="/midi-box-pro-order-secure/?add-to-cart=486638" rel="noopener noreferrer">
                                <div class="text-center mx-auto mt-3 button-green-offshadow btn-get btn-get-darks" style="background: #61CABC !important;">
                                        <span class="text-white font-weight-bold">GET MIDI
                                                        BOX
                                                        PRO NOW</span><br />
                                    <span class="small-text">30-Day
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 col-xxl-7 col-xxxl-7 mx-auto">
                            <a href="#midi-box-pricing" rel="noopener noreferrer">
                                <div class="mx-auto text-center bg-success p-3 button-green-glow">
                                        <span class="font-weight-bold text-white">GET MIDI
                                        BOX NOW</span><br />
                ...
                <div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mx-auto p-0 pl-lg-3 pr-lg-3">
                    ...
                    <div id="accordion" class="p-0 mt-4">
                        ...
                        <div class="acordion-item pointer mb-4">
                            ...
                            <div id="collapse11" data-parent="#accordion" class="collapse">
                                <div class="text-left acc-open">
                                    <p>We securely accept payments through all major credit cards and PayPal. You'll choose your payment method after you click the button below, select the Pro tier (or whatever works best for you) and go to the next
                    ...
                    <a href="#midi-box-pricing" rel="noopener noreferrer">
                        <div class="col-md-6 col-sm-8 text-center mx-auto mt-5 button-green button-green-glow">
                            <span class="font-weight-bold text-white">GET MIDI BOX NOW</span><br />
                            <span class="font-weight-bold" style="font-size: 12px;color:#8de6da; line-height: 12px">30-Day Money-Back Guarantee</span>
                        </div>
                    </a>
