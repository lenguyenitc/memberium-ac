...
<main class="flex-grow-1">
    <section class="p-0 m-0 front-cards-section front-cards-sec-v2">
        <div class="container">
            <div class="row">
                <div
                    class="col-xxxl-9 col-xxl-9 col-xl-11 col-lg-11 col-md-11 col-sm-12 mx-auto text-white p-0">
                    ...
                    <div class="row m-0 products-row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 p-0 samplepack-item samplepack-item-v2">
                            <?php if ($i == 1) : ?>
                                ...
                                <div class="card-image">
                                    ...
                                    ?>">
                                        ...
                                        <div class="image-overlay d-flex align-items-center justify-content-center">
                                            <div class="badge-pill product-cta-btn-big">Learn more</div>
                                        </div>
                                    </a>
                    ...
                    <div>
                        ...
                        <div class="col-12 page-nav border-bottom p-0">
                            <nav class="col-xxxl-12  col-xxl-12 col-xl-12 col-lg-12 col-xs-12 col-md-12 col-sm-12 mx-auto nav w-100 p-0 justify-content-around  text-uppercase font-weight-bold  mx-auto">
                        ...
                        <div class="row m-0 products-row d-none" id="midi-pack-products">
                            <?php while ($midi->have_posts()) : $midi->the_post();
                                ...
                                ?>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-xs-6 p-0 filter samplepack-item samplepack-item-v2 <?php foreach ($genre as $genr) {
                                       echo $genr->slug . ' ';
