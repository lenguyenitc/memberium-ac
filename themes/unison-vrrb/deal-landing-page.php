...
<!-- Get Drum Monkey -->
<section class="get-drum-monkey page-sec bgCover100" style="background-image:url(//deals.unison.audio/hosted/images/62/4c923bfe6b4970bb2e90b3338cee4e/Drum-Banana-Background-Reduced-.png); ">
    <div class="container">
                ...
                <div class="col-md-12">
                    <div class="section-heading text-center">
                        ...
                        <h1 class="heading d-block-770">
                            "The <strong>New Way</strong> To Produce Addictive Tracks
                            <u>In 30 Genres</u> &amp; Get <u>Infinite Inspiration</u>"
                        </h1>
                    </div>
                    <div class="video-sec">
                        <div class="video-sec-wrapper">
                            ...
                            <!-- <iframe class="wistia_embed" src="https://www.youtube.com/embed/DtJUjcBvh9E?autoplay=0&controls=0&rel=0&modestbranding=1&showinfo=0&wmode=transparent&enablejsapi=1&origin=https%3A%2F%2Fdrummonkey.unison.audio&widgetid=1" width="100%" height="360" frameborder="0" scrolling="no" allowfullscreen="allowfullscreen"></iframe> -->
                            <!-- <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DtJUjcBvh9E?autoplay=0&controls=0&rel=0&modestbranding=1&showinfo=0&wmode=transparent&enablejsapi=1&origin=https%3A%2F%2Fdrummonkey.unison.audio&widgetid=1" width="100%" height="454" frameborder="0" scrolling="no" allowfullscreen="allowfullscreen"></iframe>
                            </div> -->
                ...
                <div class="col-md-12">
                    <div class="supported-daws text-center">
                        ...
                        <div class="supported-logos d-none-770">
                            <img src="//deals.unison.audio/hosted/images/a5/572cc8a8a9442da5bf1ff851dcee81/Daw-Icons-with-bitwig.png" class="mw-100" alt="" width="800" tabindex="0">
                        </div>
                        <div class="supported-logos d-block-770">
                            <img src="//drummonkey.unison.audio/hosted/images/90/2fc5ef07554ec7a590c25af01a3f6f/DAW-Icons-Mobile-2.png" class="mw-100" alt="" width="280" tabindex="0">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="introducing-drum-monkey-inner text-center">
            <div class="heading-sec">
                ...
                <img src="//deals.unison.audio/hosted/images/75/d628b28032475aa84f235e5330eb3b/Drum-Monkey-Logo.png" class="mw-100" alt="" width="450" tabindex="0">
            </div>
            <div class="video-wrapper">
                <div class="introducing-video-sec">
                    <video width="100%" autoplay="" loop="" muted="" playsinline="" src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/Landing+Page+ScreenCaps/Top+Section/Top+Section+(Full+Screen).mp4"></video>
                </div>
            </div>
        ...
        <div class="with-drum-monkey-inner">
            <div class="section-heading text-center">
                <figure class="mb-4 pt-2">
                    <img src="//deals.unison.audio/hosted/images/c0/ee2e07dfd14c08993ffd971a3381f8/Monkey-Head-Explosion.png" class="elIMG ximg imgRoundCorners noborder imgOpacity1" alt="" width="225" tabindex="0">
                </figure>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0" style="margin-top:-45px;"><img src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/GIFs/Explosion+1/Explosion+1+GIF+(Black).gif" class="mw-100" width="375" alt="" tabindex="0"></figure>
                                <figure class="mb-0" style="margin-top:-70px;"><img src="//deals.unison.audio/hosted/images/01/c3335e8c834ac298df0229a01f334c/Grid-Image.png" class="mw-100" alt="" tabindex="0"></figure>
                            </div>
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/GIFs/Explosion+1/Explosion+1+GIF+(Black).gif" class="mw-100" alt="" tabindex="0"></figure>
                            <figure class="mb-0 mt-4 figure-2"><img src="//deals.unison.audio/hosted/images/01/c3335e8c834ac298df0229a01f334c/Grid-Image.png" class="mw-100" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/GIFs/Explosion+2/Explosion+2+GIF+(Black).gif" class="mw-100" width="375" alt=""  tabindex="0"></figure>
                            </div>
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/GIFs/Explosion+2/Explosion+2+GIF+(Black).gif" class="mw-100" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/f3/4a3bc0ccf0481d96b7533b7d8d3520/Idea-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/f3/4a3bc0ccf0481d96b7533b7d8d3520/Idea-750x750-.png" class="mw-100" alt="" width="350" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/ed/6a58f6502649b9adbf8cf348dd5690/Diving-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/ed/6a58f6502649b9adbf8cf348dd5690/Diving-750x750-.png" class="mw-100" alt="" width="350" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/a7/3f4a4521cb4f52b3509d87e7730f72/Infinite-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/a7/3f4a4521cb4f52b3509d87e7730f72/Infinite-750x750-.png" class="mw-100" alt="" width="350" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/b8/8eb46b7897418c8622b44b081bad6c/Billboard-750x750-.png" class="mw-100" width="225" alt="" width="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="//deals.unison.audio/hosted/images/b8/8eb46b7897418c8622b44b081bad6c/Billboard-750x750-.png" class="mw-100" alt="" width="350" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="drum-loop-wrap page-sec bg-secondary-black instantly-generate">
    <div class="container">
        <div class="drum-loop-inner">
            <div class="section-heading text-center">
                <figure class="mb-4">
                    <img src="//deals.unison.audio/hosted/images/d9/8eb86d870242a69633cdc72f3450ea/Drum-Explosion.png" class="elIMG ximg imgRoundCorners" alt="" width="225" tabindex="0">
                </figure>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="//deals.unison.audio/hosted/images/38/d9397227e8479c9487505f14f9e48b/Ambient-Downtempo-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/e7/386fe83a2247ac8d357b5c58c9042f/Big-Room-Progressive-House-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="//deals.unison.audio/hosted/images/22/62e4bc68c440148a9fc420143e8a7e/Country-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/04/9768f847f44c1dbf118d66678c8c59/Dancehall-Afrobeats-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/d2/1415d1e08e4df7b81dfe95f3b1648f/Disco-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/4a/6ebe05f78b41e48da98de0b8ce208a/Drum-Bass-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/5e/29be9f4e564616ac19db106f6d3778/Dubstep-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/f5/96a5e7a52e4cd293f39642b46484c1/Ethnic-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/2b/cfd1c4a8634a74ade81f890c3c4ef9/Folk-Indie-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/d5/6cd670a1f74c3dbea918a1471f7f9c/Funk-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/26/a1bbfc63c34872b423389a481ea58e/Future-Bass-Melodic-Trap-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/84/60fe4d2330427d96444cb05a04bd84/Gospel-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/fe/5d7095ab334c0b9ad92c4e6330c8c8/Hip-Hop-Rap-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/f5/bb3a090b4345c5acacfa93afe8b7fd/House-Deep-House-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/7f/378a4fcbd64f92bd7b3b397c14db31/Jazz-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/99/1f83f234d04967a2a0f122d8812861/Latin-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/d6/e7449d640246fab8f308d9ff33dc6d/Lo-Fi-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/d2/3ebafda23e4e5baad7a66989b07b88/Neo-Soul-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/ef/47cccbdd4546ab8892e7ded615d597/Pop-Future-Pop-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/b1/83463005764de0b2a8fdfaee20f9f0/R-B-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/e2/9b32ae25dd4088b47d6664725d2238/Reggae-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/71/b1c9f0c9644605adcdb2e016d4afb3/Reggaeton-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/8f/1dd2045fef49cfabe3b1ae01c42ef9/Rock-Metal-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/42/2706501b184a80bc87036fa047eb66/Soul-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/2d/4a1734ebd84fceacec611209560451/Synthwave-Synth-Pop-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/1f/25c128cdd141fcbf40d7853add1605/Techno-Melodic-Techno-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/0b/5457edf8fb4b44ae5d647dd9edfd7e/Trance-Psytrance-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/38/4388fd012d48e8a5682beda7fd6dbf/Trap-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
            ...
            <div class="demo-drum-inner pt-0 pb-4 px-0">
                <div class="row">
                    <div class="col-md-6">
                        <div class="audio_wrap h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/53/6395a2e05d4e32b78ac214989fec17/UK-Drill-UK-Grime-350x350-.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
                    ...
                    <div class="col-md-6">
                        <div class="audio_wrap audio_wrap_right h-100">
                            <div class="img-box">
                                <img src="https://drummonkey.unison.audio/hosted/images/1d/72061c34304640ad679bc71981e0c8/.png" class="elIMG ximg imgRoundCorners imgOpacity1 noShadow" alt="" width="250" tabindex="0">
                            </div>
                            <div class="title-box">
...
<!-- Quick Watch Section -->
<section class="watch-quick-video page-sec bg-white bg-image-corner" style="background-image: url(https://drummonkey.unison.audio/hosted/images/8c/604847d715458cb13a938cbe9674e0/Monkey-Head-Cover.png);">
    <div class="container">
        <div class="watch-video-inner">
            ...
            <div class="video-sec">
                <div class="video-sec-wrapper">
                    ...
                    <!-- <iframe class="wistia_embed" src="https://fast.wistia.net/embed/iframe/m6lm1g3hks?videoFoam=true" width="100%" height="100%" frameborder="0" scrolling="no" allowfullscreen="allowfullscreen"></iframe> -->
                    <!-- <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DtJUjcBvh9E" width="100%" height="454" frameborder="0" scrolling="no" allowfullscreen="allowfullscreen"></iframe>
                    </div> -->  
    ...
    <div class="container">
        <div class="watch-video-inner">
            <div class="section-heading text-center mb-4 mb-md-5">
                <figure class="mb-1">
                    <img src="//drummonkey.unison.audio/hosted/images/1c/26d8bbfb6848af9500a1aa5c5dd371/Facebook-Monkey-Smaller-.png"  class="mw-100" alt="" width="350" tabindex="0">
                </figure>
                    ...
                    <div class="col-md-4">
                        <div class="inner-column">
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/77/874d3774884660baf34b811c15b8c1/1.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/ab/b4bb17d1e44785a1195d8efe175748/15.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/9d/dd49d09447424babc229f49bc4128b/16.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/34/6058a5a69d4b12bc6073d143e904bc/2.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/28/3e593921284e378e7650b0cf39e716/19.png" class="mw-100" alt="" tabindex="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="inner-column">
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/53/f34cae5996488ebf1efc1c95af1cd9/9.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/26/cb5381336a40c18369abbed5d653ff/5.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/ef/16881897c4456b9bcf8ecbf199236b/14.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/3f/2c95703f3a4725aeb6b283f726b24e/21.png" class="mw-100" alt="" tabindex="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="inner-column">
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/78/26cd7d06b74fd2b37a9ba6da9efd2d/17.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/bb/c7261c6bc742aa818baa96d308e8d3/13.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/07/df74489e494b8da583614eb70aba6e/4.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/8b/38422c8c8b4bc9ab7fd8a2d645602b/3.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/e8/81552cd3354fec9257c34ebbe04352/22.png" class="mw-100" alt="" tabindex="0">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="generate-drum-inner">
            <div class="section-heading text-center mb-5">
                <figure class="mb-4">
                    <img src="https://drummonkey.unison.audio/hosted/images/52/0fd92d6eac4713913bb62ce31e0568/123-Explosion-Updated-v2-2.png" class="mw-100" alt="" width="350" tabindex="0">
                </figure>
...
<section class="with-drum-monkey page-sec behind-scene bg-primary-black">
    <div class="container">
        <div class="with-drum-monkey-inner">
            <div class="section-heading text-center">
                <figure class="mb-4">
                    <img src="//deals.unison.audio/hosted/images/c0/ee2e07dfd14c08993ffd971a3381f8/Monkey-Head-Explosion.png" class="mw-100" alt="" width="225" tabindex="0">
                </figure>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/19/0c42f83049463b886c4f935e048eb5/Billboard-750x750-.png" class="mw-100" width="225" alt="" width="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-5 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/19/0c42f83049463b886c4f935e048eb5/Billboard-750x750-.png" class="mw-100" width="375" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                ...
                <div class="row row-reverse">
                    <div class="col-md-7">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/7f/2b2f4021214adba7671069d49d9987/Searching-Right-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-5 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/7f/2b2f4021214adba7671069d49d9987/Searching-Right-750x750-.png" class="mw-100" width="375" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="with-drum-monkey page-sec bg-red why-reason">
    <div class="container">
        <div class="with-drum-monkey-inner">
            <div class="section-heading text-center">
                <figure class="mb-4">
                    <img src="https://drummonkey.unison.audio/hosted/images/35/108df9446447dbb15d121d28022caf/14.png" class="mw-100" alt="" width="225" tabindex="0">
                </figure>
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/f3/4a3bc0ccf0481d96b7533b7d8d3520/Idea-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/f3/4a3bc0ccf0481d96b7533b7d8d3520/Idea-750x750-.png" class="mw-100" width="350" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/51/15db19711e47aaa31d50f4faa7f0b4/Searching-Left-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/51/15db19711e47aaa31d50f4faa7f0b4/Searching-Left-750x750-.png" class="mw-100" width="350" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/13/bfcd4c79534b8f9d54451968f5b9f8/Money-Bag-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/13/bfcd4c79534b8f9d54451968f5b9f8/Money-Bag-750x750-.png" class="mw-100" width="350" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/86/39a418f8df4615a3bfd577d5915f65/No-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/86/39a418f8df4615a3bfd577d5915f65/No-750x750-.png" class="mw-100" width="350" alt=""  tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/82/544ba36cd7408496e1673ca170cb52/Beginner-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/82/544ba36cd7408496e1673ca170cb52/Beginner-750x750-.png" class="mw-100" width="350" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row row-reverse">
                    <div class="col-md-6">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/Drum-Monkey_animation_2_1x1_1_Color_.gif" class="mw-100" width="500" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content mt-sm-0">
                    ...
                    <div class="col-md-6 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/Drum-Monkey_animation_2_1x1_1_Color_.gif" class="mw-100" width="550" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="facebook-content">
                <div class="row">
                    <div class="col-md-4">
                        <div class="inner-column">
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/11/18374d091b4d93bcece0ddbc27c2ba/6-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/2d/ff26e2d61b4edfb54cc0717cdd552b/16-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/32/210601f79a46e695947f5735d04f79/9-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/85/ef9fe6a7d44aedb50ff5d6ddc42ada/13-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/c5/9dfb35eaa64bdf99de2c72ea5b2f76/4-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="inner-column">
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/cb/46c46e786944c1a0ff216db0fb1f68/5-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/0b/9946cc6eae4578a333abfedf3b25b0/7-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/49/a590aaf64d4db086625b2981eb47cf/8-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/ca/9de5042ff341c1b066bc9e1ad7a918/12-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/8d/f04442b1444c62b2ddbcd2d55497dd/11-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="inner-column">
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/54/0ace7fd7234b99897ba8ca5933a07f/18-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/1b/a26550841e46c4a9e8ebf20002cfbe/2-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/e2/adeea61c3a4ab5a98e31bb4b7a0cc7/14-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/e2/b96ca24ac54a209c7c1c90acf5e66f/17-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                            <div class="testimonial-item">
                                <img src="//drummonkey.unison.audio/hosted/images/75/1dc2f4b800465ba9d035df5892e379/3-Comment-.png" class="mw-100" alt="" tabindex="0">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="with-drum-monkey page-sec bg-yellow how-much-cost pt-3">
    <div class="container">
        <div class="with-drum-monkey-inner">
            <div class="section-heading text-center">
                <figure class="mb-1">
                    <img src="https://drummonkey.unison.audio/hosted/images/f3/0fadfe65594574ad9f048b9e5b04e8/Money-explosion.png" class="elIMG ximg imgRoundCorners noborder imgOpacity1" alt="" width="225" tabindex="0">
                </figure>
            ...
            <div class="drum-categories-sec drum-categories-inner width-sm-100">
                ...
                <div class="row row-reverse">
                    <div class="col-md-7">
                        <div class="drum-category-content h-100">
                            <h3>
                            So, Considering That This Is A <br><span class="red-text">Black Friday Special Offer...</span>
                            </h3>
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/69/7a02d7b8764d088e97e455774d8f15/Thinking-750x750-.png" class="mw-100" width="225" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                                <p>The <b>5,500+ hours and over 1 million dollars it </b>costed to create it...</p>
                    ...
                    <div class="col-md-5 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/69/7a02d7b8764d088e97e455774d8f15/Thinking-750x750-.png" class="mw-100" width="350" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="with-drum-monkey page-sec bg-primary-black exclusive-bonus">
    <div class="container">
        <div class="with-drum-monkey-inner">
            <div class="section-heading text-center">
                <figure class="mb-5">
                    <img src="https://drummonkey.unison.audio/hosted/images/c2/3037e6a9f741f1a2eb765c29e70176/3D-Bonuses-Reduced-Size-.png" class="mw-100" alt="" width="900" tabindex="0">
                </figure>
                <h2 class="heading">Plus, Get <span class="yellow-text">5 Free Exclusive Bonuses</span></h2>
                <h3 class="sub-heading mt-2">Until <span class="red-text">Monday, November 29th</span> At 11:59PM PST</h3>
            </div>
            <div class="drum-categories-sec drum-categories-inner mw-100">
                <div class="row">
                    <div class="col-md-6">
...
<!-- Time Essence -->
<section class="time-essence page-sec bg-red">  
    <div class="container">
        <div class="time-essence-inner">
            <div class="section-heading text-center">
                <h2 class="heading">Time Is Of The Essence.</h2>
                <figure class="mt-4">
                    <img src="https://drummonkey.unison.audio/hosted/images/0d/0e5374b0194f4291f93ba0bdaa2fcc/Diving-With-Clock-750x750-.png" class="mw-100" alt="" width="350" tabindex="0">
                </figure>
                <h3 class="sub-heading mt-2"> The <span class="yellow-text">Huge $100 Discount & 5 Exclusive </span> Bonuses Are <br>Only Available Until <span class="yellow-text">November 29th</span> At 11:59PM PST
                </h3>
            </div>
            <div class="content-wrap width-sm-100">
                ...
                <p>This special Black Friday deal could <b>already be over.</b></p>
...
<!-- Payment Options -->
<section class="payment-options page-sec bg-primary-black" id="scroll-Yes">      
    <div class="container">
                ...
                <div class="col-md-6">
                    <div class="column-inner h-100">
                        <div class="title-box text-center">
                            <h3>3x Monthly Payments</h3>
                            <h4>Here's <span class="red-text">What You'll Get:</span></h4>
                        </div>
                        <div class="payment-wrap">
                            <div class="payment-item">
                                <div class="img-box">
                                    <img src="//drummonkey.unison.audio/hosted/images/ea/d232892f234934889a08e1c4f7df2c/Drum-Monkey-3D-Box-400x400-.png" class="mw-100" width="130">
                                </div>
                                <div class="content-box">
                                    <h3>Unison Drum Monkey License + Lifetime Updates</h3>
                                    <p>($397 Value)</p>
                                </div>
                            </div>
                            <div class="payment-item">
                                <div class="img-box">
                                    <img src="//drummonkey.unison.audio/hosted/images/b9/8f7b1543454a84be60c340518333e4/UnisonAudio_Bonus3DBoxes_Individuals_MIDIChordMelodyBassline_01.png" class="mw-100" width="90">
                                </div>
                                <div class="content-box">
                                    <h3><span>Bonus #1:</span> Unison MIDI Chord, Melody & Bassline Collection</h3>
                                    <p>($127 Value)</p>
                                </div>
                            </div>
                            <div class="payment-item">
                                <div class="img-box">
                                    <img src="//drummonkey.unison.audio/hosted/images/24/01872d825e4835ae8cf0f6054e63cb/UnisonAudio_Bonus3DBoxes_Individuals_BassLoopPack_01.png" class="mw-100" width="90">
                                </div>
                                <div class="content-box">
                                    <h3><span>Bonus #2:</span> Unison Bass Loop Pack</h3>
                                    <p>($97 Value)</p>
                                </div>
                            </div>
                            <div class="payment-item">
                                <div class="img-box">
                                    <img src="//drummonkey.unison.audio/hosted/images/06/54d4a3313741f9a2b2766b7c83a6fe/UnisonAudio_Bonus3DBoxes_Individuals_MelodyLoopPack_01.png" class="mw-100" width="90">
                                </div>
                                <div class="content-box">
                                    <h3><span>Bonus #3:</span> Unison Melody Loop Pack</h3>
                                    <p>($97 Value)</p>
                                </div>
                            </div>
                            <div class="payment-item">
                                <div class="img-box">
                                    <img src="//drummonkey.unison.audio/hosted/images/03/6eccab17004b1aa066575fa22e7970/UnisonAudio_Bonus3DBoxes_Individuals_DrumMonkeyImpTraining_01.png" class="mw-100" width="90">
                                </div>
                                <div class="content-box">
                                    <h3><span>Bonus #4:</span> Drum Monkey Advanced Implementation Training</h3>
                                    <p>($147 Value)</p>
                                </div>
                            </div>
                            <div class="payment-item">
                                <div class="img-box">
                                    <img src="//drummonkey.unison.audio/hosted/images/d6/b321d0ccec4542ba2b84ddb31dbdb4/UnisonAudio_Bonus3DBoxes_Individuals_DrumMonkeyPFG_01.png" class="mw-100" width="90">
                                </div>
                                <div class="content-box">
                                    <h3><span>Bonus #5:</span> Private Facebook Mastermind Access</h3>
                                    <p>($197 Value)</p>
                                </div>
                            </div>
                        </div>
                        <div class="payment-price text-center">
                            ...
                            <h3>$1,062</h3>
                            <h4 class="red-text mt-3 mb-1">Limited-Time Offer:</h4>
                            <h3>3 Monthly Payments Of <span><del>$169</del></span> $129</h3>
                        </div>
                        <div class="actions-btn btn-design text-center p-0 my-3">
                            <a href="https://unison.audio/bf-drum-monkey-order-secure/" class="elButton elButtonSize1 elButtonColor1 elButtonRounded elButtonPadding2 elButtonTxtColor1 elButtonCorner5 elBTN_b_1 elButtonNoShadow elBtnVP_00 elBtnHP_40 no-button-effect elButtonFluid" rel="noopener noreferrer" id="undefined-248-238-404-339-520-806"><span class="elButtonMain">GET DRUM MONKEY NOW</span><span class="elButtonSub">For $100 Off + 5 Free Bonuses</span></a>
                        </div>
                        <p class="money-back">Try It Risk-Free | 60-Day 100% Money-Back Guarantee</p>
                        <div class="payment-methd text-center mt-2">
                            <img src="//drummonkey.unison.audio/hosted/images/images/credit-paypal.png" class="mw-100" alt="" width="250" tabindex="0">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="column-inner bg-yellow h-100">
                        <div class="title-box text-center">
                            <h3>1 Single Payment <span class="red-text">(Save $90)</span></h3>
                            <h4>Here's <span class="red-text">What You'll Get:</span></h4>
                        </div>
                        <div class="payment-wrap">
                            <div class="payment-item">
        ...
        <div class="fully-protected-inner">
            <div class="section-heading text-center">
                ...
                <figure class="mt-3 mb-3">
                    <img src="https://drummonkey.unison.audio/hosted/images/1f/e9e82615a14be283b5d284265b2c70/Monkey-Back-Monkey.png" class="mw-100" alt="" width="520" tabindex="0">
                </figure>                
            </div>
            <div class="content-wrap width-sm-100">
...
<section class="with-drum-monkey page-sec bg-primary-black are-you-ready">
    <div class="container">
        <div class="with-drum-monkey-inner">
            <div class="section-heading text-center">
                <figure class="mb-4">
                    <img src="https://drummonkey.unison.audio/hosted/images/c0/ee2e07dfd14c08993ffd971a3381f8/Monkey-Head-Explosion.png" class="elIMG ximg imgRoundCorners noborder imgOpacity1" alt="" width="225" tabindex="0">
                </figure>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/2c/e386cc495b4cad8d29379ef23c3376/Infinite-750x750-.png" class="mw-100" width="250" alt="" width="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                                <ul class="list-point">
                                    <li>
                    ...
                    <div class="col-md-5 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/2c/e386cc495b4cad8d29379ef23c3376/Infinite-750x750-.png" width="350" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="section-divider">
                ...
                <div class="row row-reverse">
                    <div class="col-md-7">
                        <div class="drum-category-content h-100">
                            ...
                            <div class="d-block-769 text-center">
                                <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/6e/76100043104fd2b3cdd38430199135/Strength-750x750-.png"  class="mw-100" width="250" alt="" tabindex="0"></figure>
                            </div>
                            <div class="category-content">
                    ...
                    <div class="col-md-5 d-none-769">
                        <div class="drum-category-image">
                            <figure class="mb-0"><img src="https://drummonkey.unison.audio/hosted/images/6e/76100043104fd2b3cdd38430199135/Strength-750x750-.png" width="350" alt="" tabindex="0"></figure>
                        </div>
                    </div>
                </div>
                <div class="row">
...
<!-- FAQ -->
<section class="faq-sec page-sec bg-white bg-image-corner" style="background-image: url(https://drummonkey.unison.audio/hosted/images/8c/604847d715458cb13a938cbe9674e0/Monkey-Head-Cover.png);">
    <div class="container">
            ...
            <div class="accordion custom-accordion width-sm-100" id="accordionExample">
                ...
                <div class="card">
                    ...
                    <div id="collapse-2" class="collapse" aria-labelledby="heading-2">
                        <div class="card-body">
                            <p>Yes, when you secure your Drum Monkey license today...<br /> <b>You'll get 100% lifetime access to everything.</b> Plus, you'll get all future Drum Monkey updates for free. That means you won't have to pay extra for new genres we may add or other new features.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div id="collapse-3" class="collapse" aria-labelledby="heading-3">
                        <div class="card-body">
                            <p>Drum Monkey is compatible <b>Ableton Live, FL Studio, Logic Pro, Pro Tools, Studio One, Cubase, Reason, Reaper, Cakewalk, Mixcraft &amp; Bitwig Studio on both Mac &amp; PC.</b> Please do not purchase Drum Monkey unless you use one of the DAW's listed.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
                ...
                <div class="card">
                    ...
                    <div id="collapse-11" class="collapse" aria-labelledby="heading-11">
                        <div class="card-body">
                            <p>We securely accept payments through <b>all major credit cards and PayPal.</b> You can pay for Drum Monkey with <b>one single payment or 3 easy monthly payments</b> after you click the button below and go to the next page. Your information is never stored or shared. We respect your privacy.</p>
                            <p>Although you <b>save an additional $90 with the full-pay option</b>, if you choose the payment plan, you pay only $129 today, followed by 2 more monthly payments of $129, totalling $387. If at any point a payment plan payment fails, your license will be paused and Drum Monkey will stop functioning until the payment goes through.</p>
                        </div>
                    </div>
                </div>
                <div class="card">
            ...
            <div class="row center-img">
                <div class="col-md-12">
                    <figure class="mb-0 text-center">
                        <img src="https://unisonlandingpagevideos.s3.us-east-2.amazonaws.com/GIFs/Explosion+2/Explosion+2+GIF+(Yellow).gif" class="mw-100" alt="" tabindex="0">
                    </figure>
                </div>
            </div>
            <div class="row">
