...
if(is_order_received_page()){
  ...
  $URL_TY = $myaccount_page.'downloads/'.(($QUERY_STRING) ? '?'.$QUERY_STRING : '');
  wp_safe_redirect( $URL_TY );
  exit;
}
?>

<body
    class="bg-dark  <?php echo $post->post_name; ?> <?php if (is_order_received_page()) echo 'order-received'; if (is_product()) echo 'individual-product-page'; ?>">
                        ...
                        <div>
                            <nav class="navbar navbar-expand-xxl navbar-dark bg-dark">
                                <a class="navbar-brand" href="/">
                                    <img class="logo-mobile" style="width:100px"
                                        src="/wp-content/uploads/2021/09/Unison-Logo-Cropped.png" alt="Logo">
                                </a>
                                <?php wp_nav_menu(
                                array(
                                    ...
                                    <div class="row">
                                        ...
                                        if (empty($first_name)) {
                                            ...
                                            <div class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenu">
                                                ...
                                                <a class="dropdown-item" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"
                            ...
                            <div class="navbar navbar-collapse" id="collapse_target1">
                                <ul class="navbar-nav navbar-top mx-auto text-uppercase align-items-center">
                                    <div class="row nav-icons">
                                        <li class="nav-item dropdown text-center">
                                            <?php if (is_user_logged_in()) { ?>
                                            <a class="nav-link my-2" id="dropdownMenu" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
                                                <img src="<?php bloginfo('template_url') ?>/assets/images/user-icon-h17.svg"
                                                    alt="User">
                                            </a>
                                            <div class="dropdown-menu text-capitalize" aria-labelledby="dropdownMenu">
