...
function isList($array)
    ...
    public static 
function convertToStripeObject($resp, $opts)
    {
        $types = [
...
function encodeParameters($params)
    ...
    public static 
function flattenParams($params, $parentKey = null)
    {
        $result = [];
    ...
    public static 
function flattenParamsList($value, $calculatedKey)
    {
        $result = [];
