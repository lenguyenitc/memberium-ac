...
class OAuth
{
    ...
    public static 
function authorizeUrl($params = null, $opts = null)
    {
        $params = $params ?: [];
    ...
    public static 
function token($params = null, $opts = null)
    {
        $base = ($opts && array_key_exists('connect_base', $opts)) ? $opts['connect_base'] : Stripe::$connectBase;
    ...
    public static 
function deauthorize($params = null, $opts = null)
    {
        $params = $params ?: [];
        $base = ($opts && array_key_exists('connect_base', $opts)) ? $opts['connect_base'] : Stripe::$connectBase;
        $requestor = new ApiRequestor(null, $base);
    ...
    private static 
function _getClientId($params = null)
    {
