...
function cancel($params = null, $opts = null)
    ...
    public static 
function createReversal($id, $params = null, $opts = null)
    {
    ...
    public static 
function retrieveReversal($id, $reversalId, $params = null, $opts = null)
    {
    ...
    public static 
function updateReversal($id, $reversalId, $params = null, $opts = null)
    {
    ...
    public static 
function allReversals($id, $params = null, $opts = null)
    {
