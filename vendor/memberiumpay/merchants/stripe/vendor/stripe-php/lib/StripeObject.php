...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public static 
function getPermanentAttributes()
    {
...
function values()
    ...
    public static 
function constructFrom($values, $opts = null)
    {
...
function refreshFrom($values, $opts, $partial = false)
    ...
    public 
function updateAttributes($values, $opts = null, $dirty = true)
    {
        foreach ($values as $k => $v) {
...
function serializeParameters($force = false)
    ...
    public 
function serializeParamsValue($value, $original, $unsaved, $force, $key = null)
    {
                                                                                                                                                                                        if ($value === null) {
            return "";
